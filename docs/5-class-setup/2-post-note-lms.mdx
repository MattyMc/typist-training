...
If you need some help learning how to create an announcement in your learning management, try searching Google for the following, depending on your learning management system: How to create an announcement in Brightspace/Blackboard/Moodle.
